...
def train_epoch(
    ...
    for cur_iter, (mag_map_s, cam_pos, cam_ori, mag_map_c) in enumerate(train_loader):
        #print(mag_map_s.shape, cam_pos.shape, cam_ori.shape, mag_map_c.shape)
        ...
        loss_fun = losses.get_loss_func(cfg.MODEL_IMAT.LOSS_FUNC)(reduction="mean")
        ...
        loss = loss_fun(preds, pred_target)
...
def eval_epoch(val_loader, model, val_meter, cur_epoch, cfg, writer=None):
    ...
    for cur_iter, (mag_map_s, cam_pos, cam_ori, mag_map_c) in enumerate(val_loader):
...
def train(cfg):
    ...
    # Print config.
    logger.info("Train IMAT with config:")
